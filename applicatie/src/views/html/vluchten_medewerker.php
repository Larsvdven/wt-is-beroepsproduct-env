...
<html lang="nl">
    <head>
        <meta charset="utf-8">
        <title>Vluchten medewerker Gelre Airport</title>
    ...
    <?php
      getHeader('vluchtdetailM');
    ?>
        <main id="vluchten_medewerkermain">
            <table>
            ...
            <div><a class="link knop knop2" href="vluchttoevoegen.php">Vlucht toevoegen</a></div>
        </main>
        <?php
          getFooter();
        ?>
